...
| **Live retail tools** | RoNtoy live economy coach and overlay; hash-bound injection, read-only state capture, passive network observation, and reversible main-thread command ingress. The hardened prelaunch gate is green; its new STOP/rearm lifecycle still needs a fresh active-match exercise. |
