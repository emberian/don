...
pub const MAP_MAKE_SCHEDULE: [MapGenerationStage; 15] = [
    ...
    MapGenerationStage {
        ...
        rng: "pool/XML bootstrap none; typed nonempty BONUS rows and first FISH row own direct/callee draws and concrete pool through category tail 0x00690225; empty FISH cleanup reaches GOODIES; recurrence/later categories open",
        checkpoint: None,
    },
    MapGenerationStage {
