...
| `arena-supply-model` | 6f | foreign/allied worker/Iroquois diplomacy, hero/caravan/merchant composition and multi-slot repair; live registry traversal, reload selection, full supply postlude and same-owner singleton worker/Iroquois healing are resolved |
