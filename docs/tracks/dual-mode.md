...
| `arena-supply-model` | foreign/allied worker/Iroquois diplomacy, remaining healing-family composition and multi-slot repair | *drift*: MODEL 6f live registry, recharge, full French/Versailles postlude and same-owner singleton worker/Iroquois healing paths are integrated | — |
