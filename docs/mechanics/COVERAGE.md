...
| 9 | `cities` | `check_cities` `0x00937600` | `City::walk_data` `0x00489220` | 110-byte POD/flags prefix plus dynamic `Array<CaravanLink>` | `tech_cities`, `don-replay::cities_runtime`, `don-replay::starting_city_unit_census` | partial; exact conditional Sim bridge plus bounded exact frame-zero Scout/Citizen census, not yet mounted; frozen constructor on 3 corpus recordings |
