...
|---|---|---|
| Retail differential oracle | green | `schema/oracle-regression.json`: 21/21 cases, 18,522,549 trials, zero mismatches/skips/crashes/errors; includes full-state turning, map/start writers, radial starts, and map-fairness distances |
